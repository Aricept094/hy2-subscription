...
```text
https://raw.githubusercontent.com/Aricept094/hy2-subscription/main/sub.txt
```

One-click Karing import:

```text
karing://install-config?url=https%3A%2F%2Fraw.githubusercontent.com%2FAricept094%2Fhy2-subscription%2Fmain%2Fsub.txt&name=Poland%20Hysteria%202
```
